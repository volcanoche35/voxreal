    ...
    <div className="flex-1 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mb-1">Welcome to VoxReal</h1>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <p className="text-center text-xs text-text-muted dark:text-text-muted-dark mt-4">
            ...
            <Link href="/register" className="text-voxreal-600 dark:text-voxreal-400 font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </form>
